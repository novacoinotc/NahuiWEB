...
const industries = [
  ...
  },
  {
    icon: Stethoscope,
    name: "Salud",
    examples: "Citas medicas, expedientes, telemedicina",
  },
  {
    icon: GraduationCap,
    name: "Educacion",
    examples: "Plataformas de cursos, gestion escolar",
  },
  {
    icon: Building2,
    name: "Inmobiliario",
  ...
  },
  {
    icon: Truck,
    name: "Logistica",
    examples: "Tracking, rutas, gestion de flotas",
  },
  {
    icon: Utensils,
    name: "Restaurantes",
  ...
  },
  {
    ...
    examples: "Facturacion, proyectos, clientes",
  },
  {
    icon: Home,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          <SectionHeader
            ...
            description="No importa tu industria. Si tienes un proceso que se puede mejorar con tecnologia, podemos ayudarte."
            centered
          />
        </motion.div>
        ...
        >
          ¿No ves tu industria? <span className="text-[#00E5FF]">Preguntanos</span> — probablemente ya hemos trabajado en algo similar.
        </motion.p>
      </div>
    </section>
  );
